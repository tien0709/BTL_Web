...
$stmt = $conn->prepare("SELECT * FROM products WHERE products_id = $pID");
                            ...
                            <?php foreach ($products as $products) { ?>
                                <div class="row order-product">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 order-product__img">
                                        <img src="<?php echo $products["image"]; ?>" alt=""></a>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 order-product__name">
                                        <a href=""><?php echo $products["products_name"]; ?></a>
                                    </div>
                                ...
                                <div class="row order_info">
                                    ...
                                    <form action="saveOrder.php" method="post">
                                        ...
                                        <input id="order" name="order" type="hidden" value="<?php
                                                                                            ...
                                                                                            echo $_POST["quantity"];
                                                                                            echo ": ";
                                                                                            echo $_POST["quantity"] * $products["price"];
                                                                                            echo "đ";
                                                                                            echo ", ";
                                    ...
                                    <div class="row gx-5">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="order-price__wrap d-flex">
                                                <span>Tổng tiền:</span>
                                                <span style="font-size: 2rem;" class="red_text"><?php echo $_POST["quantity"] * $products["price"]; ?> đ</span>
                                                <input type="hidden" name="total_price" value="<?php echo $_POST["quantity"] * $products["price"]; ?> đ"></input>
                                            </div>
