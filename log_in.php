  ...
  <section class="vh-100">
    <div class="container-fluid h-custom">
      ...
      <div class="row d-flex justify-content-center align-items-center h-100 py-4">
        ...
        <class="col-md-3 col-lg-6 col-xl-7 offset-xl-1">
          <form method="post">
           ...
           <script>
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
              <button type="submit" class="btn btn-primary btn-lg"
                style="padding-left: 2.5rem; padding-right: 2.5rem;" name="submit">Đăng nhập</button>
              <p class="small fw-bold mt-2 pt-1 mb-0">chưa có tài khoản? <a class="text-danger pe-auto" href="register.php" id="register">
                Đăng kí
              </a></p>
            </div>
